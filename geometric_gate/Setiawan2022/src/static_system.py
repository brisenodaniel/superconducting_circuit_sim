...
def build_bare_system(ct_params:dict[str,dict[str,float]],
                      stable_nlev:int=5,
                      trunc:int|None=None,
...
def build_static_system(ct_params:dict[str,dict[str,float]],
                        stable_nlev:int=5,
                        trunc:int|None=None,
                        stabilize:bool=True,
                        min_nlev:int|None=None,
    ...
    bare_system:CompositeSystem = build_bare_system(**bare_sys_params)# build_bare_systems takes same parameters as current function
